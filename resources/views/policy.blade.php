...
<div><strong>Last updated March 02, 2022</strong></div>
<div>This privacy notice for OkTracker ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>"), describes how and why we might collect, store, use, and/or share ("<strong>process</strong>") your information when you use our services ("<strong>Services</strong>"), such as when you:
<ul>
<li>Download and use our application(s), such as our mobile application &mdash; OkTracker, or any other application of ours that links to this privacy notice</li>
</ul>
<ul>
<li>Engage with us in other related ways ― including any sales, marketing, or events</li>
</ul>
<div><strong>Questions or concerns?&nbsp;</strong>Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at egidiufarcas@maze.ws.</div>
<div><strong>SUMMARY OF KEY POINTS</strong></div>
<div><strong><em>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for. You can also click&nbsp;</em></strong><a href="#toc" data-custom-class="link"><strong><em>here</em></strong></a><strong><em>&nbsp;to go directly to our table of contents.</em></strong></div>
<div><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with OkTracker and the Services, the choices you make, and the products and features you use. Click&nbsp;<a href="#personalinfo" data-custom-class="link">here</a>&nbsp;to learn more.</div>
<div><strong>Do we process any sensitive personal information?</strong> We do not process sensitive personal information.</div>
<div><strong>Do you receive any information from third parties?</strong> We do not receive any information from third parties.</div>
<div><strong>How do you process my information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. Click&nbsp;<a href="#infouse" data-custom-class="link">here</a>&nbsp;to learn more.</div>
<div><strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific third parties. Click&nbsp;<a href="#whoshare" data-custom-class="link">here</a>&nbsp;to learn more.</div>
...
<div><strong>How do I exercise my rights?</strong> The easiest way to exercise your rights is by filling out our data subject request form available <a href="https://app.termly.io/notify/09eab9d4-e35d-4951-81d1-e55dec539532" target="_blank" rel="noopener noreferrer" data-custom-class="link">here</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</div>
<div>Want to learn more about what OkTracker does with any information we collect? Click&nbsp;<a href="#toc" data-custom-class="link">here</a>&nbsp;to review the notice in full.</div>
...
<div><a href="#inforetain" data-custom-class="link">5. HOW LONG DO WE KEEP YOUR INFORMATION?</a></div>
<div><a href="#infosafe" data-custom-class="link">6. HOW DO WE KEEP YOUR INFORMATION SAFE?</a></div>
<div><a href="#privacyrights" data-custom-class="link">7. WHAT ARE YOUR PRIVACY RIGHTS?</a></div>
<div><a href="#DNT" data-custom-class="link">8. CONTROLS FOR DO-NOT-TRACK FEATURES</a></div>
<div><a href="#caresidents" data-custom-class="link">9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></div>
<div><a href="#policyupdates" data-custom-class="link">10. DO WE MAKE UPDATES TO THIS NOTICE?</a></div>
<div><a href="#contact" data-custom-class="link">11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></div>
<div><a href="#request" data-custom-class="link">12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></div>
...
<div><strong>Application Data.</strong> If you use our application(s), we also may collect the following information if you choose to provide us with access or permission:
<ul>
...
<div><strong><em>In Short:</em></strong><em>&nbsp;We may share information in specific situations described in this section and/or with the following third parties.</em></div>
...
<div><strong>5. HOW LONG DO WE KEEP YOUR INFORMATION?</strong></div>
...
<div><strong>6. HOW DO WE KEEP YOUR INFORMATION SAFE?</strong></div>
...
<div><strong>7. WHAT ARE YOUR PRIVACY RIGHTS?</strong></div>
...
<div>If you have questions or comments about your privacy rights, you may email us at egidiufarcas@maze.ws.</div>
<div><strong>8. CONTROLS FOR DO-NOT-TRACK FEATURES</strong></div>
...
<div><strong>9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></div>
...
<div>You may contact us by email at&nbsp;egidiufarcas@maze.ws, or by referring to the contact details at the bottom of this document.</div>
...
<div>OkTracker&nbsp;has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. OkTracker&nbsp;will not sell personal information in the future belonging to website visitors, users, and other consumers.</div>
...
<div>To exercise these rights, you can contact us&nbsp;by email at egidiufarcas@maze.ws, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</div>
<div><strong>10. DO WE MAKE UPDATES TO THIS NOTICE?</strong></div>
...
<div><strong>11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</strong></div>
<div>If you have questions or comments about this notice, you may email us at egidiufarcas@maze.ws&nbsp;or by post to:</div>
<div>OkTracker</div>
<div>__________</div>
<div>__________</div>
<div>Ireland</div>
<div><strong>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</strong></div>
<div>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request form by clicking&nbsp;<a href="https://app.termly.io/notify/09eab9d4-e35d-4951-81d1-e55dec539532" target="_blank" rel="noopener noreferrer" data-custom-class="link">here</a>.</div>
</div>
