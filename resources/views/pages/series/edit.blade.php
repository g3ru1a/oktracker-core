    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a href="{{ route('series.index') }}"
                class="font-normal cursor-pointer hover:underline">{{ __('Series') }}</a> / <span
                class="font-normal">{{ __('Edit') }} </span>/ {{ $series->title }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-jet-action-section title="Pointers"
                description="Follow the indications below with care. <br><br>
                        ...
                        <div class="mt-2 flex">
                            ...
                            <div class="w-full ml-1">
                                ...
                                <x-jet-input name="authors" placeholder="E.g. Seiso, Mark" type="text"
                                    ...
                                    value="{{ implode(', ', json_decode($series->authors)) }}" />
