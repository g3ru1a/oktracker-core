<div>
    <div class="w-full h-full flex items-center justify-between">
        <a href="{{ route('book.create') }}" class="h-full inline-flex bg-green-300 hover:bg-green-400 px-4 py-2 rounded-md">
        ...
        <div class="flex items-stretch">
            ...
            <div class="flex items-stretch">
                <input wire:model="lookup" type="text" placeholder="Search For Book..." class="placeholder:italic h-full ml-2 rounded-l-md">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">
                                        {{ $b->volume_number != NULL ? $b->clean_title . ", " . $b->volume_number : $b->clean_title }}
                                    </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('book.edit', ['book' => $b->id]) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
